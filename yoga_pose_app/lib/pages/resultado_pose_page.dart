...
class ResultadoPosePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool sucesso = resultado.precisao >= 0.85 && resultado.correcoes.isEmpty;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Confiança: ${(resultado.precisao * 100).toStringAsFixed(1)}%',
              style: TextStyle(
                fontSize: 16,
            ...
            if (!sucesso && resultado.correcoes.isNotEmpty) ...[
              const Text(
