...
TRAIN_PATH = os.path.join(SHARED, 'features_train_normalized.csv')
TEST_PATH = os.path.join(SHARED, 'features_test_normalized.csv')
TRAIN_OUT = os.path.join(SHARED, 'features_train_angulos.csv')
TEST_OUT = os.path.join(SHARED, 'features_test_angulos.csv')
...
def calcular_angulo(a, b, c):
    ...
    return round(angulo / 180.0, 5)  # ← Normalizado para [0.0–1.0]
